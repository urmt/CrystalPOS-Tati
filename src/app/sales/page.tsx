...
export default function SalesPage() {
  ...
  return (
    <DashboardLayout currentPage="sales" title="Sales Reports">
          ...
          <TableBody>
            {filteredSales.map(sale => (
              <TableRow key={sale.id}>
                ...
                <TableCell>{sale.customer_phone ? `${sale.customer_phone}` : '-'} {sale.customer_name ? `(${ sale.customer_name })` : ''}</TableCell>
